...
import { createLessonVariant } from "@/actions/lessons/variants";
...
import { NewPageButton, 
  LessonVariantsTabs, 
  LessonContentEditor, 
  LessonContentSidebar, 
  CreatePageDialog } from "./_components";
...
export default function LessonContentPage() {
  ...
  const handleCreateVariant = async () => {
    ...
    try {
      const res = await createLessonVariant(
        lessonId,
        newVariantName,
        newVariantSlug,
    ...
    <>
      <AdminHeader Icon={BookOpen} Paragraph={Paragraph} title={`Conteúdo - ${lesson?.name || 'Lição'}`}>
        <div className="flex gap-2">
          <Button
            variant="outline"
            onClick={() => router.push('/admin/dashboard/lessons')}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
              <div className="lg:col-span-1">
                <LessonContentSidebar
                  ...
                  onCreateBlock={(type, exerciseId, simulationId) => principal.createBlock(type, undefined, exerciseId, simulationId)}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                <div className="lg:col-span-1">
                  <LessonContentSidebar
                    ...
                    onCreateBlock={(type, exerciseId, simulationId) => variant.createBlock(type, undefined, exerciseId, simulationId)}
